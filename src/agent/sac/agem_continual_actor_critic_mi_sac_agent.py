...
from agent.sac import MultiInputSacMlpAgent, AgemContinualActorCriticSacMlpAgent


class AgemContinualActorCriticMultiInputSacMlpAgent(MultiInputSacMlpAgent,
                                                    AgemContinualActorCriticSacMlpAgent):
    ...
    def __init__(self,
        ...
        MultiInputSacMlpAgent.__init__(self, obs_shape, action_shape, action_range, device, actor_hidden_dim,
        ...
        AgemContinualActorCriticSacMlpAgent.__init__(self, obs_shape, action_shape, action_range, device,
                                                     actor_hidden_dim, critic_hidden_dim, discount, init_temperature,
                                                     alpha_lr, actor_lr, actor_log_std_min, actor_log_std_max,
                                                     actor_update_freq, critic_lr, critic_tau,
