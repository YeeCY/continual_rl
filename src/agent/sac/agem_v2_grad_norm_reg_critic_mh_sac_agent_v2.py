...
class AgemV2GradNormRegCriticMultiHeadSacMlpAgentV2(AgemV2MultiHeadSacMlpAgentV2):
    ...
    def __init__(self,
        ...
        AgemV2MultiHeadSacMlpAgentV2.__init__(self, obs_shape, action_shape, action_range, device, actor_hidden_dim,
