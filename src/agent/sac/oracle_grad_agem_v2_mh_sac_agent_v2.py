...
import utils
from agent.sac import MultiHeadSacMlpAgentV2, OracleGradAgemV2SacMlpAgentV2


class OracleGradAgemV2MultiHeadSacMlpAgentV2(MultiHeadSacMlpAgentV2, OracleGradAgemV2SacMlpAgentV2):
