...
class FisherRegularizedMTBCMlpCriticMultiHeadSacMlpAgent(SacMlpAgent):
    ...
    def train_bc(self, train_steps, step, logger):
        for train_step in train_steps:
            ...
            obses, actions, _, _, _ = self._sample_prev_transitions(
                self.batch_size)
            self.behavior_cloning.update(obses, actions)
