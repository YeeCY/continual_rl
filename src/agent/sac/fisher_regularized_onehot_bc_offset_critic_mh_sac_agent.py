...
class FisherRegularizedOneHotBCOffsetCriticMultiHeadSacMlpAgent(SacMlpAgent):
    """multi-modal behavioral cloning policy + multi-modal offset representation for critic"""
    def __init__(
            self,
            obs_shape,
            action_shape,
