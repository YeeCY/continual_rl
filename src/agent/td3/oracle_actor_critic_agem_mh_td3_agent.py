...
from agent.td3 import MultiHeadTd3MlpAgent, OracleCriticAgemTd3MlpAgent


class OracleCriticAgemMultiHeadTd3MlpAgent(MultiHeadTd3MlpAgent, OracleCriticAgemTd3MlpAgent):
