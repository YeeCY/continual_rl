...
import utils
from agent.td3 import MultiInputTd3MlpAgent, OracleGradAgemTd3MlpAgent


class OracleGradAgemMultiInputTd3MlpAgent(MultiInputTd3MlpAgent, OracleGradAgemTd3MlpAgent):
