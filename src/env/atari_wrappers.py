# (chongyi zheng): copy from https://github.com/thu-ml/tianshou/blob/master/examples/atari/atari_wrapper.py
...
def wrap_deepmind(env_id, episode_life=True, clip_rewards=True,
                  frame_skip=4, frame_stack=4, scale=False, warp_frame=True):
    """Configure environment for DeepMind-style Atari. The observation is
    channel-first: (c, h, w) instead of (h, w, c).
    :param str env_id: the atari environment id.
    :param bool episode_life: wrap the episode life wrapper.
    :param bool clip_rewards: wrap the reward clipping wrapper.
    :param int frame_skip: the frequency at which the agent experiences the game.
