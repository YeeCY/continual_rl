...
from env.utils import uniform_random_strategy


class TaskNameWrapper(gym.Wrapper):
    """
    Adapt from https://github.com/rlworkgroup/garage/blob/master/src/garage/envs/task_name_wrapper.py
...
class TaskOnehotWrapper(gym.Wrapper):
    """
    Adapt from https://github.com/rlworkgroup/garage/blob/master/src/garage/envs/task_onehot_wrapper.py
...
class MultiEnvWrapper(gym.Wrapper):
    ...
    def _update_observation_space(self):
        ...
        if self._mode == 'vanilla':
            ...
            env_lb, env_ub = self.env.observation_space.bounds
