...
for seed in "${seeds[@]}"; do
  ...
  python $PROJECT_DIR/src/train_ppo.py \
    ...
    --seed $seed \
    --work_dir $PROJECT_DIR/vec_logs/ppo_mlp_v2_overparam512_onehot_metaworld_10_tasks_sweeping_ewc/ewc_lambda100/$seed \
  > $PROJECT_DIR/terminal_logs/ppo_mlp_v2_overparam512_onehot_metaworld_10_tasks_sweeping_ewc-ewc_lambda100-seed"$seed".log 2>&1 &
done
