...
for seed in "${seeds[@]}"; do
  ...
  python $PROJECT_DIR/src/train_ppo.py \
    ...
    --seed $seed \
    --work_dir $PROJECT_DIR/vec_logs/ppo_mlp_v2_overparam_metaworld_10_tasks/ewc_lambda5000/$seed \
  > $PROJECT_DIR/terminal_logs/ppo_mlp_v2_overparam_metaworld_10_tasks-ewc_lambda5000-seed"$seed".log 2>&1 &
done
