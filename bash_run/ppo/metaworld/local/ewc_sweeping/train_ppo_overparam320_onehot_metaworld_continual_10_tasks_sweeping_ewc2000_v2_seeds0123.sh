...
for seed in "${seeds[@]}"; do
  ...
  python $PROJECT_DIR/src/train_ppo.py \
    ...
    --seed $seed \
    --work_dir $PROJECT_DIR/vec_logs/ppo_mlp_v2_overparam320_onehot_metaworld_10_tasks_sweeping_ewc/ewc_lambda2000/$seed \
  > $PROJECT_DIR/terminal_logs/ppo_mlp_v2_overparam320_onehot_metaworld_10_tasks_sweeping_ewc-ewc_lambda2000-seed"$seed".log 2>&1 &
done
