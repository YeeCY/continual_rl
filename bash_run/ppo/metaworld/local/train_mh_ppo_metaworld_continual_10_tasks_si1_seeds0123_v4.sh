...
for seed in "${seeds[@]}"; do
  ...
  python $PROJECT_DIR/src/train_ppo.py \
    ...
    --ppo_si_c 1 \
    --seed $seed \
    --work_dir $PROJECT_DIR/vec_logs/mh_ppo_mlp_metaworld_10_tasks_v4/si_c1/$seed \
  > $PROJECT_DIR/terminal_logs/mh_ppo_mlp_metaworld_10_tasks_v4-si_c1-seed"$seed".log 2>&1 &
done
