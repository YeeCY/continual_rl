...
for seed in "${seeds[@]}"; do
  ...
  python $PROJECT_DIR/src/train_ppo.py \
    ...
    --ppo_si_c 10 \
    --seed $seed \
    --work_dir $PROJECT_DIR/vec_logs/ppo_mlp_v2_overparam_metaworld_10_tasks/si_c10/$seed \
  > $PROJECT_DIR/terminal_logs/ppo_mlp_v2_overparam_metaworld_10_tasks-si_c10-seed"$seed".log 2>&1 &
done
