...
for seed in "${seeds[@]}"; do
  ...
  python $PROJECT_DIR/src/train_ppo.py \
    ...
    --ppo_si_c 10 \
    --seed $seed \
    --work_dir $PROJECT_DIR/vec_logs/mh_ppo_mlp_metaworld_10_tasks_v2/si_c10/$seed \
  > $PROJECT_DIR/terminal_logs/mh_ppo_mlp_metaworld_10_tasks_v2-si_c10-seed"$seed".log 2>&1 &
done
