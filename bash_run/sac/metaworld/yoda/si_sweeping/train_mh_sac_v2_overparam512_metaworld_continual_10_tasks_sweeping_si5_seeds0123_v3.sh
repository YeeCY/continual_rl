...
for seed in "${seeds[@]}"; do
  ...
  python $PROJECT_DIR/src/train_sac.py \
    ...
    --sac_si_c 5 \
    --seed $seed \
    --work_dir $PROJECT_DIR/vec_logs/mh_sac_mlp_v2_overparam512_metaworld_10_tasks_sweeping_si/si_c5/$seed \
    > $PROJECT_DIR/terminal_logs/mh_sac_mlp_v2_overparam512_metaworld_10_tasks_sweeping_si-si_c5-seed"$seed".log 2>&1 &
done
