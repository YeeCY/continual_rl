...
for seed in "${seeds[@]}"; do
  ...
  python $PROJECT_DIR/src/train_sac.py \
    ...
    --seed $seed \
    --work_dir $PROJECT_DIR/vec_logs/grad_norm_reg_critic_mi_sac_mlp_metaworld_10_tasks/ewc_lambda5000_hybrid_100_fisher_iters_grad_norm_coeff_10.0/$seed \
    > $PROJECT_DIR/terminal_logs/grad_norm_reg_critic_mi_sac_mlp_metaworld_10_tasks-ewc_lambda5000_hybrid_100_fisher_iters_grad_norm_coeff_10.0-seed"$seed".log 2>&1 &
done
