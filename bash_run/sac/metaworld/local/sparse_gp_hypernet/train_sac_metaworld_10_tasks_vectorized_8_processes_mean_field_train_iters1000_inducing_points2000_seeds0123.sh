...
for seed in "${seeds[@]}"; do
  ...
  python $PROJECT_DIR/src/train_sac.py \
    ...
    --work_dir $PROJECT_DIR/vec_logs/gp_hypernet_sac_mlp_metaworld/mean_field_train_iters1000_inducing_points2000/$seed \
    > $PROJECT_DIR/terminal_logs/gp_hypernet_sac_mlp_metaworld-mean_field_train_iters1000_inducing_points2000-seed"$seed".log 2>&1 &
done
