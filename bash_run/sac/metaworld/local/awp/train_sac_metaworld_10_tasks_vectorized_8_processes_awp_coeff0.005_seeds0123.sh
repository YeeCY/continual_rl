...
for seed in "${seeds[@]}"; do
  ...
  python $PROJECT_DIR/src/train_sac.py \
    ...
    --work_dir $PROJECT_DIR/vec_logs/awp_sac_mlp_metaworld/awp_coeff0.005/$seed \
    > $PROJECT_DIR/terminal_logs/awp_sac_mlp_metaworld-awp_coeff0.005-seed"$seed".log 2>&1 &
done
