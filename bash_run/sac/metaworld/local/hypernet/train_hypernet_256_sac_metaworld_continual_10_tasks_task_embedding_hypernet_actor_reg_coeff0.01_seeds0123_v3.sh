...
for seed in "${seeds[@]}"; do
  ...
  python $PROJECT_DIR/src/train_sac.py \
    ...
    --seed $seed \
    --work_dir $PROJECT_DIR/vec_logs/hypernet_sac_mlp_metaworld_10_tasks/task_embedding_hypernet_actor_256_reg_coeff0.01/$seed \
    > $PROJECT_DIR/terminal_logs/hypernet_sac_mlp_metaworld_10_tasks-task_embedding_hypernet_actor_256_reg_coeff0.01-seed"$seed".log 2>&1 &
done
