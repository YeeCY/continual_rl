...
for seed in "${seeds[@]}"; do
  ...
  python $PROJECT_DIR/src/train_sac.py \
    ...
    --seed $seed \
    --work_dir $PROJECT_DIR/vec_logs/mh_sac_mlp_v2_overparam256_metaworld_10_tasks_sweeping_ewc/ewc_lambda2000/$seed \
    > $PROJECT_DIR/terminal_logs/mh_sac_mlp_v2_overparam256_metaworld_10_tasks_sweeping_ewc-ewc_lambda2000-seed"$seed".log 2>&1 &
done
