...
for seed in "${seeds[@]}"; do
  ...
  python $PROJECT_DIR/src/train_sac.py \
    ...
    --sac_si_c 10 \
    --seed $seed \
    --work_dir $PROJECT_DIR/vec_logs/mh_sac_mlp_v2_mujoco_10_tasks_improvement/si_c10/$seed \
    > $PROJECT_DIR/terminal_logs/mh_sac_mlp_v2_mujoco_10_tasks_improvement-si_c10-seed"$seed".log 2>&1 &
done
